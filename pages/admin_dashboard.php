...
require_once '../includes/repositories/CommandeRepository.php';
...
$count_orders = $commandeRepo->countAll();
$total_ca = $commandeRepo->sumTotalPrix();
$all_orders = $commandeRepo->findAllWithDetails();
